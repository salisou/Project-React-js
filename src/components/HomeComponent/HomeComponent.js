...
export default function HomeComponent() {
  ...
  function uploadImage(e) {
    ...
    if (file !== null) {
      ...
      alert("Per prima cosa devi selezionare un'immagine");
    }
  }
  ...
  return (
    <div>
      <div className="container" style={{ marginTop: "2%" }}>
        <center>
          <img src={imageURL} alt="caricare un file" style={{ width: "300px" }} />
          <br />
          <br />
          <input
            class="form-control "
        ...
        >
          ...
          {GetText ? (
            ...
            <div>
              ...
              Estrai il testo dalle immagini (JPG, PNG) e converti in formato di output di testo modificabile
              </p>
              <h6 className="text-center">
              Sviluppato da DotEnv @Moussa
              </h6>
            </div>
          )}
        </div>
